...
function fnManifiesto()
{
	this.Buscar=function()
	{
		$( "#action" ).attr( 'value', 'find' );
		$("#frm_prefer").submit();
		Mensaje( "Buscando manifiestos" );
	}
	...
	this.importarSumaKilos=function(noFila)
	{
		...
		suma+=parseFloat("0"+($("#resext01_"+noFila).length>0?$("#resext01_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext02_"+noFila).length>0?$("#resext02_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext03_"+noFila).length>0?$("#resext03_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext04_"+noFila).length>0?$("#resext04_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext05_"+noFila).length>0?$("#resext05_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext06_"+noFila).length>0?$("#resext06_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext07_"+noFila).length>0?$("#resext07_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext08_"+noFila).length>0?$("#resext08_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext09_"+noFila).length>0?$("#resext09_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext10_"+noFila).length>0?$("#resext10_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext11_"+noFila).length>0?$("#resext11_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext12_"+noFila).length>0?$("#resext12_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext13_"+noFila).length>0?$("#resext13_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext14_"+noFila).length>0?$("#resext14_"+noFila).val():0));
		suma+=parseFloat("0"+($("#resext15_"+noFila).length>0?$("#resext15_"+noFila).val():0));
		...
		if(this.importarValidaFilas())
		{
			...
			for(var idx in filas) if(!isNaN(idx))
			{
				var tmpManif={
					...
					r_ext01		: $("#resext01_"+filas[idx]).length>0?$("#resext01_"+filas[idx]).val():"0",
					r_ext02		: $("#resext02_"+filas[idx]).length>0?$("#resext02_"+filas[idx]).val():"0",
					r_ext03		: $("#resext03_"+filas[idx]).length>0?$("#resext03_"+filas[idx]).val():"0",
					r_ext04		: $("#resext04_"+filas[idx]).length>0?$("#resext04_"+filas[idx]).val():"0",
					r_ext05		: $("#resext05_"+filas[idx]).length>0?$("#resext05_"+filas[idx]).val():"0",
					r_ext06		: $("#resext06_"+filas[idx]).length>0?$("#resext06_"+filas[idx]).val():"0",
					r_ext07		: $("#resext07_"+filas[idx]).length>0?$("#resext07_"+filas[idx]).val():"0",
					r_ext08		: $("#resext08_"+filas[idx]).length>0?$("#resext08_"+filas[idx]).val():"0",
					r_ext09		: $("#resext09_"+filas[idx]).length>0?$("#resext09_"+filas[idx]).val():"0",
					r_ext10		: $("#resext10_"+filas[idx]).length>0?$("#resext10_"+filas[idx]).val():"0",
					r_ext11		: $("#resext11_"+filas[idx]).length>0?$("#resext11_"+filas[idx]).val():"0",
					r_ext12		: $("#resext12_"+filas[idx]).length>0?$("#resext12_"+filas[idx]).val():"0",
					r_ext13		: $("#resext13_"+filas[idx]).length>0?$("#resext13_"+filas[idx]).val():"0",
					r_ext14		: $("#resext14_"+filas[idx]).length>0?$("#resext14_"+filas[idx]).val():"0",
					r_ext15		: $("#resext15_"+filas[idx]).length>0?$("#resext15_"+filas[idx]).val():"0",
				}; 
